...
import { createDesktopDataService } from "../electron/data.mjs";
import { stableManagementIpcError } from "../electron/managementIpcError.mjs";
import {
  createProcessExitError,
  createRunTerminationError,
  readRunErrorCode,
  stableRunIpcError,
} from "../electron/runIpcError.mjs";
import { expectedRendererDocumentUrl, isTrustedRendererContext, isTrustedRendererDocument } from "../electron/rendererTrust.mjs";
import { createActiveRunRegistry } from "../electron/runLifecycle.mjs";

const rendererFilePath = "/tmp/hireme/renderer/dist/index.html";
...
assert.equal(packagedUrl, "file:///tmp/hireme/renderer/dist/index.html");
...
assert.equal(isTrustedRendererDocument({
  currentUrl: "file:///tmp/hireme/renderer/dist/other.html",
  isPackaged: true,
  rendererFilePath,
}), false);

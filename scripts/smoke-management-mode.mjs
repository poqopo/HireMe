...
import { createStandaloneAgent } from "../apps/agent/src/runtime.mjs";
...
} from "../apps/agent/src/managementModePolicy.mjs";
...
function runCliJson(args) {
  return new Promise((resolveRun, rejectRun) => {
    const child = spawn(process.execPath, ["bin/hireme.mjs", ...args], {
      cwd: process.cwd(),
      env: process.env,

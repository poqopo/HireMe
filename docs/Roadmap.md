...
HireMe의 중심 제품은 비개발자 프리랜서도 사용할 수 있는 데스크톱 작업
공간입니다. CLI는 같은 runtime을 사용하는 고급 인터페이스로 유지합니다.

핵심 제품 약속:

```text
사용자는 전문 Agent의 결과를 얻는다.
제작자는 자신의 작업 방식과 IP를 유지한다.
HireMe는 사용 권한, 실행, 버전, 수익을 연결한다.
```
